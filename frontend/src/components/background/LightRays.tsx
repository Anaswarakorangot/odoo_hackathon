...
const getAnchorAndDir = (origin: RaysOrigin, width: number, height: number) => {
  ...
  switch (origin) {
    case 'top-left':
      return { anchor: [0, -outside * height], dir: [0, 1] as [number, number] };
    case 'top-right':
      return { anchor: [width, -outside * height], dir: [0, 1] as [number, number] };
    case 'left':
      return { anchor: [-outside * width, 0.5 * height], dir: [1, 0] as [number, number] };
    case 'right':
      return { anchor: [(1 + outside) * width, 0.5 * height], dir: [-1, 0] as [number, number] };
    case 'bottom-left':
      return { anchor: [0, (1 + outside) * height], dir: [0, -1] as [number, number] };
    case 'bottom-center':
      return { anchor: [0.5 * width, (1 + outside) * height], dir: [0, -1] as [number, number] };
    case 'bottom-right':
      return { anchor: [width, (1 + outside) * height], dir: [0, -1] as [number, number] };
    default:
      return { anchor: [0.5 * width, -outside * height], dir: [0, 1] as [number, number] };
  }
};
